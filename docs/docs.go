...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.GetCinema"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.CinemaSeat"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "models.Ticket": {
            ...
            "properties": {
                "date": {
                    "description": "Format: 07 Jul 2025",
                    "type": "string"
                },
                "movie_title": {
                    "type": "string"
